...
- Doubling the amount of constant-time passes doesn’t change the asymptotic complexity.
- You're still touching each pixel a constant number of times with a small kernel.
